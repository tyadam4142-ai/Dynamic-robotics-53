...
(function () {
  ...
  function initBoot() {
    ...
    /* Fresh visit: fast premium entrance. Returning visits skip it. */
    if (REDUCE || sessionStorage.getItem('dr53_booted_v2')) {
      boot.remove();
    ...
    setTimeout(function () {
      ...
      document.body.classList.add('page-ready');
      sessionStorage.setItem('dr53_booted_v2', '1');
